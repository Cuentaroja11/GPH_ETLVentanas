...
def extraer_info(carpeta_entrada, archivo_salida):
    datos_extraidos = [['Canal', 'Frecuencia (MHz)', 'Nivel (dBmV)', 'MER (dB)', 'BER (Previo)', 'BER (Posterior)', 'Eco (dBc)', 'Retardo de grupo (ns)', 'ICFR (dB)', 'Zumbido (%)', 'DQI', 'Estrés AGC', 'Delta de canal adyacente (dB)']]
